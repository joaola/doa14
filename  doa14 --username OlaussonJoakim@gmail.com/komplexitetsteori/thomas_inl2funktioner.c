...
int main(void) {
    ...
    shuffle_array_really_well(b2b, 6);
    printf("Blandad (2) b2b: %f %f %f %f %f %f\n", b2b[0], b2b[1], b2b[2], b2b[3], b2b[4], b2b[5]);
    shuffle_array_really_really_well(b2b, 6);
    printf("Blandad (3) b2b: %f %f %f %f %f %f\n", b2b[0], b2b[1], b2b[2], b2b[3], b2b[4], b2b[5]);
    shuffle_array_really_really_really_well(b2b, 6);
    printf("Blandad (4) b2b: %f %f %f %f %f %f\n", b2b[0], b2b[1], b2b[2], b2b[3], b2b[4], b2b[5]);
    shuffle_array_really_really_really_really_well(b2b, 6);
    printf("Blandad (5) b2b: %f %f %f %f %f %f\n", b2b[0], b2b[1], b2b[2], b2b[3], b2b[4], b2b[5]);
